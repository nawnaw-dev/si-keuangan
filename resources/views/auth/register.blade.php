...
@section('content')
  <div class="min-h-screen bg-white flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      <div
        class="rounded-2xl border border-white/20 bg-gradient-to-b from-[#123458] to-[#2770BE] backdrop-blur-md p-8 shadow-xl">
        ...
        <form method="POST" action="{{ route('register') }}" novalidate>
          ...
          <!-- Name -->
          <div class="mb-4">
            <label for="email" class="block text-sm font-semibold text-white/90">Your Name</label>
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-white/80">
            ...
            <a href="{{ route('login') }}"
              class="font-semibold text-white hover:text-gray-200 underline-offset-2 hover:underline">Sign in</a>
          </p>
        </div>
