  ...
  <div class="w-full max-w-md">
    <div class="rounded-2xl border border-white/20 bg-gradient-to-b from-[#123458] to-[#2770BE] backdrop-blur-md p-8 shadow-xl">
      ...
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-sm text-white/80">Welcome to Koin Kene</p>
      </div>
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-white/80">
          ...
          <a href="{{ route('register') }}" class="font-semibold text-white hover:text-gray-200 underline-offset-2 hover:underline">Sign up</a>
        </p>
      </div>

      <!-- Terms note -->
      <p class="mt-6 text-center text-xs text-white/60">
        By signing in, you agree to Koin Kene Terms of Service
      </p>
    </div>
  </div>
</div>
